    ...
    public partial class FRMSearch : Form
    {
        ...
        void Listele()
        {
            ...
            var LST = (from k in _db.tblHastaBilgileris
                       ...
                       && k.tblPatolojikVerilers.First().PATOLOJI.Contains(cbPatolojiArama.Text)
            ...
            foreach (var hast in LST)
            {
                ...
                Liste.Rows[pp].Cells[5].Value = hast.tblPatolojikVerilers.First(x => x.HastaID == hast.ID).PATOLOJI;
        ...
        void Combox()
        {
            ...
            var lst2 = _db.tblPatolojikVerilers.Select(s => s.PATOLOJI).Distinct();
