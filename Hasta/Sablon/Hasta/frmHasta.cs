...
namespace Sablon.Hasta
{
    public partial class frmHasta : Form
    {
        ...
        void Combox()
        {
            ...
            var lst5_1 = _db.dbo_tblPatolojikVerilers.Select(k => k.PATOLOJI).Distinct();
            ...
            var lst5_2 = _db.dbo_tblPatolojikVerilers.Select(k => k.ALT_GRUP).Distinct();
            ...
            var lst5_3 = _db.dbo_tblPatolojikVerilers.Select(k => k.FURHMAN_GRADE).Distinct();
            ...
            var lst5_4 = _db.dbo_tblPatolojikVerilers.Select(k => k.PATOLOJIK_EVRE).Distinct();
        ...
        void YeniKaydet()
        {
            try
            {
                ...
                dbo_tblPatolojikVeriler Patol = new dbo_tblPatolojikVeriler();
                ...
                _db.dbo_tblPatolojikVerilers.InsertOnSubmit(Patol);
                #endregion
